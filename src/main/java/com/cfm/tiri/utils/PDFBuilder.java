...
public class PDFBuilder extends AbstractITextPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document doc, PdfWriter writer, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	...
    	@SuppressWarnings("unchecked")
		List<RouteDetailedReport> fuelDetailedConsumptionReport =   (List<RouteDetailedReport>) model.get("fueldetailedconsumptionreport");
        ...
        for (RouteReport report : fuelConsumptionReport) {
        	...
        	cell.setPhrase(new Phrase(String.valueOf(df2.format(report.getAverageConsumption())), arialblack));
            table.addCell(cell);
        ...
        detailedCell.setPhrase(new Phrase("czynność", arial));
        detailedTable.addCell(detailedCell);
        
        detailedCell.setPhrase(new Phrase("nr rejestracyjny", arial));
        detailedTable.addCell(detailedCell);
        
        detailedCell.setPhrase(new Phrase("Data początkowa", arial));
        detailedTable.addCell(detailedCell);
        ...
        detailedCell.setPhrase(new Phrase("Średnie zyżycie na 100 km według normy", arial));
        detailedTable.addCell(detailedCell);
        ...
        for (RouteDetailedReport report : fuelDetailedConsumptionReport) {
            ...
            detailedCell.setPhrase(new Phrase(String.valueOf(df2.format(report.getWeightOfCargo())), arialblack));
            detailedTable.addCell(detailedCell);
