...
import com.cfm.tiri.services.security.EncryptionService;
...
public class UserServiceMapImpl extends AbstractMapService implements UserService {
    ...
    public User findByUsername(String userName) {
        ...
        Optional returnUser =  domainMap.values().stream().filter(new Predicate<JPAObject>() {
            @Override
            public boolean test(JPAObject domainObject) {
